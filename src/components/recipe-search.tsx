...
import DarkModeToggle from "./Darkmode-button";
  ...
  return (
    <div className="flex flex-col h-full w-full max-w-6xl mx-auto p-4 md:p-6">
      ...
      <header className="flex flex-col items-center mb-6">
        <div className="absolute right-4 items-end">
        <DarkModeToggle/>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="flex space-x-2">
            {examples.map((example) => (
              <span
                key={example}
                className="px-2 py-1 bg-gray-200 rounded-md cursor-pointer dark:text-black"
